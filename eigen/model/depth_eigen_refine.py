...
class Depth_Eigen_Refine(nn.Module):
    def __init__(self, **cfg):
        super(Depth_Eigen_Refine, self).__init__()
        ...
        self.coarse_model = Depth_Eigen_Coarse(**cfg)

        # Specify the path to the .pth file
        cur_path = os.getcwd()
        path = cur_path + '/runs/NYU/depth_eigen_coarse/RN50/temp0.1/dl1/best.pth'
...
def depth_eigen_refine(**kwargs):
    model = Depth_Eigen_Refine(**kwargs)
    return model